 ...
 *   pnpm --filter @pinhaoji/worker task -- <taskName>
 * 例：pnpm --filter @pinhaoji/worker task -- renewal.invoices
 */
...
if (!taskName) {
  console.error("用法：pnpm --filter @pinhaoji/worker task -- <taskName>");
  console.error("可用任务：");
